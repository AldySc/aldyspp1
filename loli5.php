                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="input-group-prepend">
                        ...
                        <input type="date" class="form-control" name="bulan_dibayar" value="<?php echo $data['bulan_dibayar']; ?>"  />
                      </div>
                    </div>
                       <div class="form-group">
                      ...
                      <div class="input-group-prepend">
                        ...
                        <input type="date" class="form-control" name="tahun_dibayar" value="<?php echo $data['tahun_dibayar']; ?>"  />
                      </div>
                    </div>
                         <div class="form-group">           
